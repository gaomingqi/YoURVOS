"""
Pre-Training script of YoURVOS baseline
...
def main(args):
    ...
    if args.distributed:
        # mute sentence features would cause error: Expected to have finished reduction in the prior iteration before
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('OMFormer pretrain training and evaluation script', parents=[opts.get_args_parser()])
